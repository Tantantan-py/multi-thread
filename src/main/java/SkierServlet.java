...
public class SkierServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (urlPath == null || urlPath.isEmpty()) {
            ...
            res.getWriter().write("doGet - missing URL parameters");
            return;
        }
        ...
        if (!isUrlValid(urlParts)) {
            res.setStatus(HttpServletResponse.SC_NOT_FOUND);
            res.getWriter().write("doGet - invalid URL parameters");
        } else {
            res.setStatus(HttpServletResponse.SC_OK);
            // TODO (maybe also some value if input is valid?)
            res.getWriter().write("doGet works!");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (urlPath == null || urlPath.isEmpty()) {
            ...
            response.getWriter().write("doPost - missing URL parameters");
            return;
        }
        ...
        if (!isUrlValid(urlParts)) {
            response.setStatus(HttpServletResponse.SC_NOT_FOUND);
            response.getWriter().write("doPost - invalid URL parameters");
            return;
        }
