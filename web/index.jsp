...
<div class="container">
    <div class="intro">
        ...
        <div class="tooltip">
            <a href="https://github.khoury.northeastern.edu/gphipps/cs6650/blob/main/Labs/Lab1.md" class="btn"
               target="_blank" rel="noopener noreferrer">
                Lab 1
            </a>
            <span class="tooltiptext">Open Lab 1 Instruction </span>
        </div>
        <div class="tooltip">
            <a href="https://github.khoury.northeastern.edu/gphipps/cs6650/blob/main/Labs/Lab2.md" class="btn"
               target="_blank" rel="noopener noreferrer">
                Lab 2
            </a>
            <span class="tooltiptext">Open Lab 2 Instruction </span>
        </div>
        <div class="tooltip">
            <a href="https://github.khoury.northeastern.edu/gphipps/cs6650/blob/main/Labs/Lab3.md" class="btn"
               target="_blank" rel="noopener noreferrer">
                Lab 3
            </a>
            <span class="tooltiptext">Open Lab 3 Instruction </span>
        </div>
